  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group relative p-0 text-center text-sm focus-within:relative focus-within:z-20 aria-selected:bg-accent [&[aria-selected].day-outside]:bg-accent/50 [&[aria-selected].day-range-end]:rounded-r-md",
          props.mode === "range"
